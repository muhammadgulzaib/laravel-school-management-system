...
@section('content')
    ...
    <div class="roles-permissions">
        <div class="flex items-center justify-between mb-6">
            <div>
                <h2 class="text-gray-700 uppercase font-bold">Exam Time Table</h2>
            </div>
        ...
        <div class="table w-full mt-8 bg-white rounded">
            <form action="{{ route('exam.time.table.store') }}" method="POST" class="w-full px-6 py-12">
                @csrf
                        ...
                        <table class="table table-bordered text-center">
                            ...
                            {{--                            @foreach(\App\Services\TimeTableService::getTimeTableSection($section->id) as $timeTable)--}}
                                <tr>
                                    ...
                                    <td>
                                        @foreach(\App\Services\TimeTableService::getExamTimeTableDayClass($section->id,$section->grade[0]->id,"Monday") as $data)
                                    ...
                                    <td>
                                        @foreach(\App\Services\TimeTableService::getExamTimeTableDayClass($section->id,$section->grade[0]->id,"Tuesday") as $data)
                                            <div class="p-5 border">
                                                <div class="margin-10px-top font-size14">{{ $data->teacher->user->name ?? '' }}</div>
                                                <div class="margin-10px-top font-size14"><b>{{ $data->subject->name ?? '' }}</b></div>
                                                <div class="font-size13 text-light-gray">{{ $data->class_start_time }}</div>
                                    ...
                                    <td>
                                        @foreach(\App\Services\TimeTableService::getExamTimeTableDayClass($section->id,$section->grade[0]->id,"Wednesday") as $data)
                                            <div class="p-5 border">
                                                <div class="margin-10px-top font-size14">{{ $data->teacher->user->name ?? '' }}</div>
                                                <div class="margin-10px-top font-size14"><b>{{ $data->subject->name ?? '' }}</b></div>
                                                <div class="font-size13 text-light-gray">{{ $data->class_start_time }}</div>
                                    ...
                                    <td>
                                        @foreach(\App\Services\TimeTableService::getExamTimeTableDayClass($section->id,$section->grade[0]->id,"Thursday") as $data)
                                            <div class="p-5 border">
                                                <div class="margin-10px-top font-size14">{{ $data->teacher->user->name ?? '' }}</div>
                                                <div class="margin-10px-top font-size14"><b>{{ $data->subject->name ?? '' }}</b></div>
                                                <div class="font-size13 text-light-gray">{{ $data->class_start_time }}</div>
                                    ...
                                    <td>
                                        @foreach(\App\Services\TimeTableService::getExamTimeTableDayClass($section->id,$section->grade[0]->id,"Friday") as $data)
                                            <div class="p-5 border">
                                                <div class="margin-10px-top font-size14">{{ $data->teacher->user->name ?? '' }}</div>
                                                <div class="margin-10px-top font-size14"><b>{{ $data->subject->name ?? '' }}</b></div>
                                                <div class="font-size13 text-light-gray">{{ $data->class_start_time }}</div>
